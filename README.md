...
[Latest Official Build v1.1.2.1](https://github.com/Terence0816/RustDesk-QuickHost/releases/tag/v1.1.2.1) |
...
* Official `v1.1.0.0` build: [RustDeskQS.exe](https://github.com/Terence0816/RustDesk-QuickHost/releases/tag/V1.1.0.0)
...
* 官方 `v1.1.0.0` 版本：[RustDeskQS.exe](https://github.com/Terence0816/RustDesk-QuickHost/releases/tag/V1.1.0.0)
